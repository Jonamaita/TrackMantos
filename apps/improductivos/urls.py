...
urlpatterns = [
    ...
    path('',login_required(improductivos_form),name="improductivos_form"),#si fuera vista basada en clases, se le pasa el parametro ImproductivoCreate, como esta definida en las vistas basadas en clases
    ...
    path('improductivos_edit/<int:pk>/',login_required(ImproductivosUpdate.as_view()),name="improductivos_edit"), #paso primary key, ya que, es por vista basada en clases.
   	path('improductivos_delete/<int:pk>/',login_required(ImproductivosDelete.as_view()),name="improductivos_delete"),
