...
urlpatterns = [
	...
	#path('producciones_delete/<slug:pk>/',staff_member_required(ProduccionesDelete.as_view()),name="producciones_delete"), # Por vista
	#path('producciones_delete/<slug:pk>/',staff_member_required(produccion_delete),name="producciones_delete"),
